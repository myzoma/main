...
const pages = [
  ...
  "مدعوم بمؤشر ST,Yas-1 و ST,Yas-2",
    ...
    {
        id: 8,
        title: "انعكاس الترندات",
        description: "تحديد مستويات انعكاس الترندات الهابطة",
        icon: "fa-solid fa-chart-line",
        url: "https://myzoma.github.io/Reval/",
        features: [
            "تحديد مستويات الانعكاس",
            "تحديد قوة الانعكاس",
            "تحديد نقاط نقاط الانعكاس",
            "تحديد الاشارات",
            "تحديد شروط الانعكاس",
        ]
    },
